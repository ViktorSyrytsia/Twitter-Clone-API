...
export class TweetsController extends ControllerBase {
    ...
    public async deleteTweet(
        ...
        try {
            ...
            if (!((tweetToDelete.author as User)._id.equals(principal.details._id))) {
                return this._fail(
                    res,
    ...
    public async updateTweet(
        ...
        try {
            ...
            if (!((tweetToUpdate.author as User)._id.equals(principal.details._id))) {
                return this._fail(
                    res,
                    new HttpError(FORBIDDEN, 'Not an owner of a tweet')
                );
    ...
    public async likeTweet(
        ...
        try {
            ...
            if ((tweetToLike.likes as User[]).map(user => user._id.toHexString()).includes(principal.details._id.toHexString())) {
                return this._fail(
                    res,
    ...
    public async unlikeTweet(
        ...
        try {
            ...
            if (!(tweetToUnlike.likes as User[]).map(user => user._id.toHexString()).includes(principal.details._id.toHexString())) {
                return this._fail(
                    res,
    ...
    @httpPost('/retweet/:id', AuthMiddleware)
