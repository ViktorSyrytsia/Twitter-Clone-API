...
export class CommentController extends ControllerBase {
    ...
    public async updateComment(
        ...
        try {
            ...
            if (!((comment.author as User)._id.equals(principal.details._id))) {
                return this._fail(
                    res,
    ...
    public async likeComment(
        ...
        try {
            ...
            if ((comment.likes as User[]).map(user => user._id.toHexString()).includes(principal.details._id.toHexString())) {
                return this._fail(
                    res,
